...
char const COMMENT_1 = ';';
char const COMMENT_2 = '#';
char const SLASH = '/';
char const SPACE = ' ';
char const TILDE = '~';
...
int const TIME_WEEKS = 2;
int const TIME_MONTHS = 3;
int const TIME_YEARS = 4;
...
int const RASTER_PLOT_AVG_WAVE_ANGLE = 6;
int const RASTER_PLOT_AVG_WAVE_HEIGHT = 7;
...
int const RASTER_PLOT_CONS_SED_SLOPE = 22;
int const RASTER_PLOT_DEEP_WATER_WAVE_ANGLE = 23;
int const RASTER_PLOT_DEEP_WATER_WAVE_HEIGHT = 24;
...
int const RASTER_PLOT_SED_TOP_INC_TALUS_ELEV = 43;
int const RASTER_PLOT_SHADOW_DOWNDRIFT_ZONE = 44;
int const RASTER_PLOT_SHADOW_ZONE = 45;
int const RASTER_PLOT_SLICE = 46;
int const RASTER_PLOT_SLOPE_FOR_CLIFF_TOE = 47;
int const RASTER_PLOT_SUSPENDED_SEDIMENT = 48;
int const RASTER_PLOT_TALUS = 49;
int const RASTER_PLOT_TOP_ELEV_INC_SEA = 50;
int const RASTER_PLOT_TOTAL_ACTUAL_BEACH_EROSION = 51;
int const RASTER_PLOT_TOTAL_ACTUAL_PLATFORM_EROSION = 52;
int const RASTER_PLOT_TOTAL_BEACH_DEPOSITION = 53;
int const RASTER_PLOT_TOTAL_CLIFF_COLLAPSE_DEPOSITION_COARSE = 54;
int const RASTER_PLOT_TOTAL_CLIFF_COLLAPSE_DEPOSITION_SAND = 55;
int const RASTER_PLOT_TOTAL_CLIFF_COLLAPSE_EROSION_COARSE = 56;
int const RASTER_PLOT_TOTAL_CLIFF_COLLAPSE_EROSION_FINE = 57;
int const RASTER_PLOT_TOTAL_CLIFF_COLLAPSE_EROSION_SAND = 58;
int const RASTER_PLOT_TOTAL_POTENTIAL_BEACH_EROSION = 59;
int const RASTER_PLOT_TOTAL_POTENTIAL_PLATFORM_EROSION = 60;
int const RASTER_PLOT_UNCONS_TOT_UPRUSH_COARSE = 61;
int const RASTER_PLOT_UNCONS_TOT_UPRUSH_SAND = 62;
int const RASTER_PLOT_UNCONS_UPRUSH_COARSE = 63;
int const RASTER_PLOT_UNCONS_UPRUSH_SAND = 64;
int const RASTER_PLOT_WAVE_ANGLE = 65;
int const RASTER_PLOT_WAVE_HEIGHT = 66;

// GIS vector output codes
int const VECTOR_PLOT_AVG_WAVE_ANGLE_AND_HEIGHT = 1;
int const VECTOR_PLOT_BREAKING_WAVE_HEIGHT = 2;
int const VECTOR_PLOT_CLIFF_NOTCH_ACTIVE = 3;
int const VECTOR_PLOT_COAST = 4;
int const VECTOR_PLOT_COAST_CURVATURE = 5;
int const VECTOR_PLOT_COAST_SWL_HIGHEST = 6;
int const VECTOR_PLOT_COAST_SWL_LOWEST = 7;
int const VECTOR_PLOT_DEEP_WATER_WAVE_ANGLE_AND_HEIGHT = 8;
int const VECTOR_PLOT_DOWNDRIFT_ZONE_BOUNDARY = 9;
...
int const VECTOR_PLOT_WAVE_TRANSECT_POINTS = 21;
...
int const RTN_ERR_DOWNDRIFT_ZONE_FLOOD_FILL_NOGRID = 55;
int const RTN_ERR_SHADOW_ZONE_FLOOD_START_POINT= 56;
int const RTN_ERR_DOWNDRIFT_ZONE_FLOOD_START_POINT= 57;
int const RTN_ERR_CSHORE_EMPTY_PROFILE = 58;
int const RTN_ERR_CSHORE_FILE_INPUT = 59;
int const RTN_ERR_READING_CSHORE_FILE_OUTPUT = 60;
int const RTN_ERR_WAVE_INTERPOLATION_LOOKUP = 61;
int const RTN_ERR_GRIDCREATE = 62;
int const RTN_ERR_COAST_CANT_FIND_EDGE_CELL = 63;
int const RTN_ERR_CSHORE_ERROR = 64;
int const RTN_ERR_NO_CELL_UNDER_COASTLINE = 65;
int const RTN_ERR_OPEN_DEEP_WATER_WAVE_DATA = 66;
int const RTN_ERR_READING_DEEP_WATER_WAVE_DATA = 67;
int const RTN_ERR_BOUNDING_BOX = 68;
int const RTN_ERR_READING_SEDIMENT_INPUT_EVENT = 69;
int const RTN_ERR_SEDIMENT_INPUT_EVENT = 70;
int const RTN_ERR_SEDIMENT_INPUT_EVENT_LOCATION = 71;
int const RTN_ERR_WAVESTATION_LOCATION = 72;
int const RTN_ERR_FLOOD_LOCATION = 73;
int const RTN_ERR_CLIFF_NOT_IN_POLYGON = 74;
int const RTN_ERR_CELL_MARKED_PROFILE_COAST_BUT_NOT_PROFILE = 75;
int const RTN_ERR_TRACING_FLOOD = 76;
int const RTN_ERR_NO_START_FINISH_POINTS_TRACING_COAST = 77;
int const RTN_ERR_NO_VALID_COAST = 78;
int const RTN_ERR_COAST_TRACING_REPEATING = 79;
int const RTN_ERR_COAST_TRACING_SAME_START_FINISH = 80;
int const RTN_ERR_COAST_TRACING_ZERO_LENGTH = 81;
int const RTN_ERR_COAST_TRACING_TOO_SHORT = 82;
int const RTN_ERR_COAST_TRACING_TOO_LONG = 83;
int const RTN_ERR_COAST_TRACING_OFF_EDGE = 84;
int const RTN_ERR_CELL_NOT_FOUND_IN_HIT_PROFILE_DIFFERENT_COASTS = 85;
int const RTN_ERR_POINT_NOT_FOUND_IN_MULTILINE_DIFFERENT_COASTS = 86;
int const RTN_ERR_CELL_NOT_FOUND_IN_HIT_PROFILE = 87;
int const RTN_ERR_CELL_IN_POLY_BUT_NO_POLY_COAST = 88;
int const RTN_ERR_CLIFF_TALUS_TO_UNCONS = 89;
int const RTN_ERR_COAST_TRACING_SAME_EDGE_START_FINISH = 90;
int const RTN_ERR_POLYGON_FILL_START_POINT = 91;
int const RTN_ERR_BASEMENT_DURING_BARRIER_CREATION = 92;
int const RTN_ERR_BASEMENT_DURING_WAVE_CALC = 93;
int const RTN_ERR_NO_POLYGONS = 94;
int const RTN_ERR_GRID_EDGE_PROFILE_TOO_SHORT = 95;
int const RTN_ERR_SHADOW_BOUNDARY_NOGOOD = 96;
int const RTN_ERR_DOWNDRIFT_BOUNDARY_NOGOOD = 97;
...
int const SMOOTH_RUNNING_MEDIAN = 2;
int const SMOOTH_SAVITZKY_GOLAY = 3;
...
double const BERM_SLOPE = 5.0;                              // Seaward slope of top of berm (that part of beach coastward of the start of the Dean profile) in degrees
...
string const PROGRAM_NAME = "Coastal Modelling Environment (CoastalME) version 1.4.3 (04 Sep 2026)";
string const PROGRAM_NAME_SHORT = "CME";
string const CME_INI = "cme.ini";
string const CME_YAML = "cme.yaml";

string const COPYRIGHT = "(C) 2026 Andres Payo, David Favis-Mortlock, and Wilf Chun";
string const LINE = "-------------------------------------------------------------------------------";
...
string const RASTER_AVG_WAVE_ANGLE_CODE = "avg_wave_angle";
string const RASTER_AVG_WAVE_ANGLE_NAME = "avg_wave_angle";
...
string const RASTER_DEEP_WATER_WAVE_ANGLE_CODE = "deep_water_wave_angle";
string const RASTER_DEEP_WATER_WAVE_ANGLE_NAME = "deep_water_wave_angle";
...
string const RASTER_UNCONS_TOT_UPRUSH_COARSE_NAME = "tot_uprush_coarse";
string const RASTER_UNCONS_TOT_UPRUSH_SAND_NAME = "tot_uprush_sand";
string const RASTER_UNCONS_UPRUSH_COARSE_CODE = "uprush_coarse";
string const RASTER_UNCONS_UPRUSH_COARSE_NAME = "uprush_coarse";
string const RASTER_UNCONS_UPRUSH_SAND_CODE = "uprush_sand";
string const RASTER_UNCONS_UPRUSH_SAND_NAME = "uprush_sand";
...
string const RASTER_WAVE_ANGLE_CODE = "wave_angle";
string const RASTER_WAVE_ANGLE_NAME = "wave_angle";
...
string const RASTER_PLOT_AVG_WAVE_ANGLE_TITLE = "Average wave orientation";
...
string const RASTER_PLOT_DEEP_WATER_WAVE_ANGLE_TITLE = "Deep water wave orientation";
...
string const RASTER_PLOT_UNCONS_TOT_UPRUSH_COARSE_TITLE = "Unconsolidated coarse sediment from wave uprush since start of simulation";
string const RASTER_PLOT_UNCONS_TOT_UPRUSH_SAND_TITLE = "Unconsolidated sand sediment from wave uprush since start of simulation";
string const RASTER_PLOT_UNCONS_UPRUSH_COARSE_TITLE = "This-iteration unconsolidated coarse sediment from wave uprush";
string const RASTER_PLOT_UNCONS_UPRUSH_SAND_TITLE = "This-iteration unconsolidated sand sediment from wave uprush";
string const RASTER_PLOT_WAVE_ANGLE_TITLE = "Wave orientation";
