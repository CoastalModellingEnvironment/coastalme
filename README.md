...
# CoastalME
The [latest release](https://github.com/coastalme/coastalme/releases) is version 1.4. (26 Nov 2025).

The [main branch][https://github.com/CoastalModellingEnvironment/coastalme] is also 1.4.0.

The [development branch][https://github.com/CoastalModellingEnvironment/coastalme/tree/develop] is version 1.4.1 (09 Jan 2026). It should work well, but use at your own risk.
