...
int CSimulation::nDoAllPropagateWaves(void)
{
   ...
   {
      if (m_pRasterGrid->m_Cell[nX][0].bIsSea())
      {
      ...
      if (m_pRasterGrid->m_Cell[nX][m_nYGridSize - 1].bIsSea())
      {
   ...
   {
      if (m_pRasterGrid->m_Cell[0][nY].bIsSea())
      {
      ...
      if (m_pRasterGrid->m_Cell[m_nXGridSize - 1][nY].bIsSea())
      {
   ...
   for (int nX = 0; nX < m_nXGridSize; nX++)
   {
      for (int nY = 0; nY < m_nYGridSize; nY++)
      {
         if (m_pRasterGrid->m_Cell[nX][nY].bIsSea())
         {
            ...
            {
               if (m_pRasterGrid->m_Cell[nXTmp][nYTmp].bIsSea())
               {
                  nRead++;
