...
{
   int const nCat = m_pRasterGrid->m_Cell[nX][nY].pGetCellLandform()->nGetLandformCategory();
...
//===============================================================================================================================
//! If two 2D integer points are adjacent, return true; otherwise returns false
//===============================================================================================================================
bool CSimulation::bIsAdjacent(CGeom2DIPoint const* pPtiA, CGeom2DIPoint const* pPtiB)
{
   int nXDiff = abs(pPtiA->nGetX() - pPtiB->nGetX());
   int nYDiff = abs(pPtiA->nGetY() - pPtiB->nGetY());
