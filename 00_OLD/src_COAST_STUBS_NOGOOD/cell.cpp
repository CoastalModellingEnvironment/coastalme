...
//! Set this cell to be a sea cell (but is not necessarily in contiguous sea)
void CGeomCell::SetSea(void)
{
   m_bIsSea = true;
}

//! Is this a sea cell? (May not be in contiguous sea)
bool CGeomCell::bIsSea(void) const
{
   return m_bIsSea;
}
